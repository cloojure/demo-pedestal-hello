(ns demo-pedestal-hello.service
  (:require [io.pedestal.http                         :as ped-http]
            ...
            [demo-pedestal-hello.peer                 :as peer])
  ...
  (interceptor/interceptor 
      :error (fn [ctx excp]  
                ...
                (let [baos  (ByteArrayOutputStream.)
                      pw    (PrintWriter. baos)
                      _     (.fillInStackTrace excp)
                      _     (.printStackTrace excp pw)
                      _     (.flush pw)
...
;; Consumed by demo-pedestal-hello.server/runnable-service
